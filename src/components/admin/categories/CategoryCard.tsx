  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-xl border border-safra-taupe/40 bg-white transition-all hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col p-4">
        <Link href={`/admin/categories/${category.id}`} className="block hover:text-safra-gold transition-colors">
          <h3 className="font-semibold">{getCategoryName(category, locale)}</h3>
        </Link>
